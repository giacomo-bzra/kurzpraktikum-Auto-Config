...
public class Car
{
    ...
    public Car( string carId, string brand, string modell, double price, int baseHorsepower, int currentHorsepower, double baseWeight, double currentWeight, List<TuningPart> initialParts, string color)
    {
        this.CarId = carId;
        this.Brand = brand;
        this.Modell = modell;
