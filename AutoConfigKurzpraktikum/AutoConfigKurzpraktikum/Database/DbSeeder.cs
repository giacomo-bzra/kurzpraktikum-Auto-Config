...
public static class DbSeeder
{
    ...
    public static async Task SeedParts(IMongoDatabase database)
    {
        ...
        var parts = new List<TuningPart>
        {
            ...
            new Engine(ObjectId.GenerateNewId().ToString(), "Turbo-Motor 600 PS", 18000, 210, false, "Schwarz", 13.0, 600),
            new Engine(ObjectId.GenerateNewId().ToString(), "V8-Biturbo 800 PS", 35000, 240, false, "Gold/Schwarz", 18.5, 800),
            new Engine(ObjectId.GenerateNewId().ToString(), "Elektro-Antrieb Unit X", 22500, 150, false, "Neon-Blau", 0.0, 450),
            ...
            new Frontspoiler(ObjectId.GenerateNewId().ToString(), "Breiter Front-Splitter", 1100, 5.0, false, "Weiß", 90),
            new Frontspoiler(ObjectId.GenerateNewId().ToString(), "Aero-Dynamic Lippe", 850, 2.8, false, "Schwarz-Matt", 65),
            new Frontspoiler(ObjectId.GenerateNewId().ToString(), "Street-Style Splitter", 400, 4.5, false, "Wagenfarbe", 30),
            ...
            new Heckspoiler(ObjectId.GenerateNewId().ToString(), "Dragster-Wing High-Downforce", 2100, 6.5, false, "Carbon", 350),
            new Heckspoiler(ObjectId.GenerateNewId().ToString(), "Dezente Abrisskante", 250, 1.2, false, "Schwarz-Glanz", 150),
            ...
            new Rimm(ObjectId.GenerateNewId().ToString(), "Carbon-Fiber Ultra Light 21\"", 4500, 5.2, false, "Carbon-Sichtgewebe", 21),
            ...
            // ── Tires ────────────────────────────────────────────────────────────
            new Tire(ObjectId.GenerateNewId().ToString(), "Slick Race-Reifen", 600, 7.0, false, "Schwarz", AutoConfigKurzpraktikum.Models.Parts.Type.Race, 25, 40),
            new Tire(ObjectId.GenerateNewId().ToString(), "Drift-Reifen", 450, 8.5, false, "Schwarz", AutoConfigKurzpraktikum.Models.Parts.Type.Drift, 30, 10),
            new Tire(ObjectId.GenerateNewId().ToString(), "Offroad-Reifen", 500, 12.0, false, "Schwarz", AutoConfigKurzpraktikum.Models.Parts.Type.Offroad, 45, 35),
            new Tire(ObjectId.GenerateNewId().ToString(), "Allwetter-Performance", 250, 9.5, false, "Schwarz", AutoConfigKurzpraktikum.Models.Parts.Type.Drift, 35, 25),
            new Tire(ObjectId.GenerateNewId().ToString(), "Pro-Rain Wet-Slick", 550, 7.5, false, "Schwarz", AutoConfigKurzpraktikum.Models.Parts.Type.Race, 28, 50),
            new Tire(ObjectId.GenerateNewId().ToString(), "Extreme-Grip Winter", 320, 10.5, false, "Schwarz", AutoConfigKurzpraktikum.Models.Parts.Type.Offroad, 40, 60),
            new Tire(ObjectId.GenerateNewId().ToString(), "Derby-Tires", 550, 7.5, false, "Schwarz", AutoConfigKurzpraktikum.Models.Parts.Type.Derby, 28, 80),
            new Tire(ObjectId.GenerateNewId().ToString(), "Relley-Tires", 320, 10.5, false, "Schwarz", AutoConfigKurzpraktikum.Models.Parts.Type.Ralley, 60, 35),
            new Tire(ObjectId.GenerateNewId().ToString(), "Drag-Tires", 320, 10.5, false, "Schwarz", AutoConfigKurzpraktikum.Models.Parts.Type.Drag, 60, 100),
            new Tire(ObjectId.GenerateNewId().ToString(), "Basic Tire", 0, 5, false, "Black", AutoConfigKurzpraktikum.Models.Parts.Type.Race, 5, 15),
            new Tire(ObjectId.GenerateNewId().ToString(), "Thin Eco Tire", 0, 4, false, "Black", AutoConfigKurzpraktikum.Models.Parts.Type.Race, 3, 10)
        };
        ...
        var cars = new List<Car>
        {
            new Car(
                ...
                initialParts: new List<TuningPart>
                {
                    ...
                    new Tire(ObjectId.GenerateNewId().ToString(), "Basic Tire", 0, 5, true, "Black", AutoConfigKurzpraktikum.Models.Parts.Type.Race, 5, 15),
            ...
            new Car(
                ...
                initialParts: new List<TuningPart>
                {
                    new Engine(ObjectId.GenerateNewId().ToString(), "Lawnmower Engine", 0, 80, true, "Rusty Brown", 5.0, 45),
                    ...
                    new Tire(ObjectId.GenerateNewId().ToString(), "Thin Eco Tire", 0, 4, true, "Black", AutoConfigKurzpraktikum.Models.Parts.Type.Race, 3, 10),
